...
StaticForge automates the entire process of deploying static sites (Docusaurus, Next.js, Vite, Hugo, etc.) to AWS infrastructure with:
...
Then ask: "Initialize a Docusaurus project with StaticForge"
...
Then ask: "Create AWS infrastructure with StaticForge"
...
Then ask: "Deploy my site with StaticForge"

## Available Commands

| Command | Description |
|---------|-------------|
| `/staticforge init` | Initialize Docusaurus project |
| `/staticforge infra` | Create AWS infrastructure |
| `/staticforge deploy` | Build and deploy site |
| `/staticforge status` | Check infrastructure status |
