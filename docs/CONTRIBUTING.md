# Contributing to StaticForge

Thank you for your interest in contributing to StaticForge! This document provides guidelines and instructions for contributing.
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/staticforge.git
cd staticforge

# Test the plugin locally
claude plugins add-local ./plugin/staticforge
...
│   ├── init.md          # /staticforge init
│   ├── infra.md         # /staticforge infra
│   ├── deploy.md        # /staticforge deploy
│   └── status.md        # /staticforge status
├── skills/              # Skills
│   └── staticforge.md   # Main skill
...
Thank you for contributing to StaticForge!
